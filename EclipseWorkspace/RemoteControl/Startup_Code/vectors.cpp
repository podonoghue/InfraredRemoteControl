...
VectorTable const __vector_table = {
   ...
   &__StackTop,                                /*    0   -16  Initial stack pointer                                                            */
   {
      ...
      Cmt::irqHandler,                         /*   43,   27  Carrier Modulator Transmitter                                                    */
      RTC_Alarm_IRQHandler,                    /*   44,   28  Real Time Clock                                                                  */
      RTC_Seconds_IRQHandler,                  /*   45,   29  Real Time Clock                                                                  */
      Pit::irqHandler<Pit::IrqNum_Ch0>,        /*   46,   30  Periodic Interrupt Timer                                                         */
      Pit::irqHandler<Pit::IrqNum_Ch1>,        /*   47,   31  Periodic Interrupt Timer                                                         */
      Pit::irqHandler<Pit::IrqNum_Ch2>,        /*   48,   32  Periodic Interrupt Timer                                                         */
      Pit::irqHandler<Pit::IrqNum_Ch3>,        /*   49,   33  Periodic Interrupt Timer                                                         */
