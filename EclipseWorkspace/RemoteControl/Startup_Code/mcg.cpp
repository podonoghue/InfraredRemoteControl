...
const ClockInfo Mcg::clockInfo[] = {
   ...
   {  // ClockConfig_RUN_PEE_48MHz (McgClockMode_PEE)
      ...
      McgFllPrescale_HighDivBy256 |     // (mcg_c1_frdiv[0])          FLL External Reference Divider - /256 (high)
      ...
      McgPllLossOfClockReset_Disabled,  // (mcg_c8_lolre[0])          PLL Loss of Lock Reset Enable - Interrupt request
