/******************************************************************************
 * @file tft_ILI9341.h (180.ARM_Peripherals/Snippets)
 *
 ...
 *    orientation
 ******************************************************************************/
#ifndef INCLUDE_USBDM_ILI9341_H
#define INCLUDE_USBDM_ILI9341_H
/*
 * *****************************
...
//                                              |||
//                                              vvv
   Orientation_Mirrored_XequalsY            = 0b000'0'1000, // RGB + Mirrored across X=-Y axis
   Orientation_Normal                       = 0b001'0'1000, // RGB + Rotated 180 degrees
   Orientation_Rotated_90                   = 0b010'0'1000, // RGB + Rotated 90 degrees
   Orientation_Mirrored_YAxis               = 0b011'0'1000, // RGB + Mirrored across X Axis
   Orientation_Rotated_270                  = 0b100'0'1000, // RGB + Rotated 270 degrees
   Orientation_Mirrored_XAxis               = 0b101'0'1000, // RGB + Mirrored across Y Axis
   Orientation_Mirrored_XequalsMinusY       = 0b110'0'1000, // RGB + Mirrored across X=Y axis
   Orientation_Rotated_180                  = 0b111'0'1000, // RGB + Normal
};

template<Orientation orientation=Orientation_Normal>
class TFT_ILI9341 : public FormattedIO {

   using SELF = TFT_ILI9341;

protected:

static constexpr unsigned Width()  {
   static constexpr unsigned widths[]  = { 320, 240, 320, 240, 320, 240, 320, 240, };
    return widths[orientation>>5]; 
 }
 
static constexpr unsigned Height() {
   static constexpr unsigned heights[] = { 240, 320, 240, 320, 240, 320, 240, 320, };
...
protected:
   ...
   enum Command {
      ...
      Command_GetRedChannel                  = 0x06,
      Command_GetGreenChannel                = 0x07,
      Command_GetBlueChannel                 = 0x08,
      ...
      Command_SetBlankingPorch               = 0xB5,
      Command_DisplayFunctionControl         = 0xB6,
      Command_SetEntryMode                   = 0xB7,
      Command_GateDriverDirectionControl     = 0xB8,
      ...
      Command_NVMemoryFunctionController     = 0xD7,
      Command_GetID1                         = 0xDA,
      Command_GetID2                         = 0xDB,
      Command_GetID3                         = 0xDC,
      Command_NVMemoryFunctionController2    = 0xDE,
      Command_PositiveGammaControl           = 0xE0,
      Command_NegativeGammaControl           = 0xE1,
      Command_GammaSetting_Green             = 0xF2,
   };
...
public:
    ...
    */
   TFT_ILI9341(Spi &spi, const Font *font=&font8x8) :
      spi(spi),
...
//         }
   ...
   void initialise() {
      ...
      static constexpr uint8_t initSequence[] = {
            ...
            // Power control 1, 1 args, no delay
            DELAY|1, Command_PowerControl1,
            0x23,
            10,                           // 10 ms delay
            ...
            // Set pixel format, 1 arg, no delay
            DELAY|1, Command_SetPixelFormat,
            RgbInterfaceFormat_RBG565|McuPixelFormat_RBG565,
            10,                           // 10ms delay ?

            // Frame rate control - normal mode, 2 args: Rate = 200kHz/(LINE+VPC)(DIVC+4) = 64.4 Hz
            DELAY|2,  Command_SetFrameRateNormalMode,
            0,     // DIVA=0 (fosc),  Division ratio for internal clocks when Normal mode.
            0x18,  // RTNA=79Hz, Frame rate
            10,                                 // 10 ms delay ?

            // Display Function Control
            3, Command_DisplayFunctionControl,
            0b0000'10'00, // PTG=10 (interval scan), PT=00 (V63 V0 VCOML VCOMH)
            0x82, // REV=1 (white), GS,SS,SM,ISC=2 (5 frames, 85ms)
            0x27, // NL=320
            ...
            //         0b0000'0'11'0, // DSTB=0(disabled), GON/DTE=3(Normal display), GAS=0(disabled)
