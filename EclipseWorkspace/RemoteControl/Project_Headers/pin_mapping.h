 ...
 * @version   1.3.0
 * @brief     Peripheral declarations for MK20DX64VLF5
 *
 * *****************************
 ...
 */
   ...
   // Bit operators for RAR register fields
   constexpr inline uint8_t operator|(RtcRarIerr op1, RtcRarLrr op2)  { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarIerr op1, RtcRarSrr op2)  { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarIerr op1, RtcRarCrr op2)  { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarIerr op1, RtcRarTcrr op2) { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarIerr op1, RtcRarTarr op2) { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarIerr op1, RtcRarTprr op2) { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarIerr op1, RtcRarTsrr op2) { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarLrr op1, RtcRarIerr op2)  { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarLrr op1, RtcRarSrr op2)   { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarLrr op1, RtcRarCrr op2)   { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarLrr op1, RtcRarTcrr op2)  { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarLrr op1, RtcRarTarr op2)  { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarLrr op1, RtcRarTprr op2)  { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarLrr op1, RtcRarTsrr op2)  { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarSrr op1, RtcRarIerr op2)  { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarSrr op1, RtcRarLrr op2)   { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarSrr op1, RtcRarCrr op2)   { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarSrr op1, RtcRarTcrr op2)  { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarSrr op1, RtcRarTarr op2)  { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarSrr op1, RtcRarTprr op2)  { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarSrr op1, RtcRarTsrr op2)  { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarCrr op1, RtcRarIerr op2)  { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarCrr op1, RtcRarLrr op2)   { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarCrr op1, RtcRarSrr op2)   { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarCrr op1, RtcRarTcrr op2)  { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarCrr op1, RtcRarTarr op2)  { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarCrr op1, RtcRarTprr op2)  { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarCrr op1, RtcRarTsrr op2)  { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarTcrr op1, RtcRarIerr op2) { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarTcrr op1, RtcRarLrr op2)  { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarTcrr op1, RtcRarSrr op2)  { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarTcrr op1, RtcRarCrr op2)  { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarTcrr op1, RtcRarTarr op2) { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarTcrr op1, RtcRarTprr op2) { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarTcrr op1, RtcRarTsrr op2) { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarTarr op1, RtcRarIerr op2) { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarTarr op1, RtcRarLrr op2)  { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarTarr op1, RtcRarSrr op2)  { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarTarr op1, RtcRarCrr op2)  { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarTarr op1, RtcRarTcrr op2) { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarTarr op1, RtcRarTprr op2) { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarTarr op1, RtcRarTsrr op2) { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarTprr op1, RtcRarIerr op2) { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarTprr op1, RtcRarLrr op2)  { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarTprr op1, RtcRarSrr op2)  { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarTprr op1, RtcRarCrr op2)  { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarTprr op1, RtcRarTcrr op2) { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarTprr op1, RtcRarTarr op2) { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarTprr op1, RtcRarTsrr op2) { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarTsrr op1, RtcRarIerr op2) { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarTsrr op1, RtcRarLrr op2)  { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarTsrr op1, RtcRarSrr op2)  { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarTsrr op1, RtcRarCrr op2)  { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarTsrr op1, RtcRarTcrr op2) { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarTsrr op1, RtcRarTarr op2) { return uint8_t(op1)|uint8_t(op2); };
   constexpr inline uint8_t operator|(RtcRarTsrr op1, RtcRarTprr op2) { return uint8_t(op1)|uint8_t(op2); };
 ...
 */
   ...
   // Bit operators for SOPT5 register fields
   constexpr inline uint32_t operator|(SimUart0RxSrc op1, SimUart0TxSrc op2) { return uint32_t(op1)|uint32_t(op2); };
   constexpr inline uint32_t operator|(SimUart0RxSrc op1, SimUart1RxSrc op2) { return uint32_t(op1)|uint32_t(op2); };
   constexpr inline uint32_t operator|(SimUart0RxSrc op1, SimUart1TxSrc op2) { return uint32_t(op1)|uint32_t(op2); };
   constexpr inline uint32_t operator|(SimUart0TxSrc op1, SimUart0RxSrc op2) { return uint32_t(op1)|uint32_t(op2); };
   constexpr inline uint32_t operator|(SimUart0TxSrc op1, SimUart1RxSrc op2) { return uint32_t(op1)|uint32_t(op2); };
   constexpr inline uint32_t operator|(SimUart0TxSrc op1, SimUart1TxSrc op2) { return uint32_t(op1)|uint32_t(op2); };
   constexpr inline uint32_t operator|(SimUart1RxSrc op1, SimUart0RxSrc op2) { return uint32_t(op1)|uint32_t(op2); };
   constexpr inline uint32_t operator|(SimUart1RxSrc op1, SimUart0TxSrc op2) { return uint32_t(op1)|uint32_t(op2); };
   constexpr inline uint32_t operator|(SimUart1RxSrc op1, SimUart1TxSrc op2) { return uint32_t(op1)|uint32_t(op2); };
   constexpr inline uint32_t operator|(SimUart1TxSrc op1, SimUart0RxSrc op2) { return uint32_t(op1)|uint32_t(op2); };
   constexpr inline uint32_t operator|(SimUart1TxSrc op1, SimUart0TxSrc op2) { return uint32_t(op1)|uint32_t(op2); };
   constexpr inline uint32_t operator|(SimUart1TxSrc op1, SimUart1RxSrc op2) { return uint32_t(op1)|uint32_t(op2); };
   

   // Bit operators for SOPT7 register fields
   constexpr inline uint32_t operator|(SimAdc0TriggerMode op1, SimAdc0TriggerSrc op2)  { return uint32_t(op1)|uint32_t(op2); };
   constexpr inline uint32_t operator|(SimAdc0TriggerSrc op1, SimAdc0TriggerMode op2)  { return uint32_t(op1)|uint32_t(op2); };
   

   // Bit operators for CLKDIV1 register fields
   constexpr inline uint32_t operator|(SimCoreClkDivider op1, SimBusClkDivider op2)    { return uint32_t(op1)|uint32_t(op2); };
   constexpr inline uint32_t operator|(SimCoreClkDivider op1, SimFlashClkDivider op2)  { return uint32_t(op1)|uint32_t(op2); };
   constexpr inline uint32_t operator|(SimBusClkDivider op1, SimCoreClkDivider op2)    { return uint32_t(op1)|uint32_t(op2); };
   constexpr inline uint32_t operator|(SimBusClkDivider op1, SimFlashClkDivider op2)   { return uint32_t(op1)|uint32_t(op2); };
   constexpr inline uint32_t operator|(SimFlashClkDivider op1, SimCoreClkDivider op2)  { return uint32_t(op1)|uint32_t(op2); };
   constexpr inline uint32_t operator|(SimFlashClkDivider op1, SimBusClkDivider op2)   { return uint32_t(op1)|uint32_t(op2); };
...
public:
   ...
   static void setFtm0ExternalClock(SimFtm0ClkSel simFtm0ClkSel) {
      sim->SOPT4 = (sim->SOPT4&~SIM_SOPT4_FTM0CLKSEL_MASK) | uint32_t(simFtm0ClkSel);
   }
   ...
   static void setFtm1ExternalClock(SimFtm1ClkSel simFtm1ClkSel) {
      sim->SOPT4 = (sim->SOPT4&~SIM_SOPT4_FTM1CLKSEL_MASK) | uint32_t(simFtm1ClkSel);
   }
   ...
   static constexpr uint32_t usbExternalClock=48000000;
   ...
   { // ClockConfig_RUN_PEE_48MHz (McgClockMode_PEE)
      ...
      SimUsbFullSpeedClockSource_External ,       // (sim_sopt2_usbsrc[0])      USB Clock - External bypass clock (USB_CLKIN)
...
public:
   ...
   static void setStartScan(TsiSoftwareTrigger tsiSoftwareTrigger) {
      tsi->GENCS = (tsi->GENCS&~TSI_GENCS_SWTS_MASK) | uint32_t(tsiSoftwareTrigger);
   }
