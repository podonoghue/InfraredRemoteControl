...
#ifndef HEADER_FTFL_H
#define HEADER_FTFL_H
...
// No handler defined for FTFL Command
// No handler defined for FTFL ReadCollision
...
public:
    ...
    */
   enum IrqNum {
      IrqNum_Command         = 0,  ///< Maps to FTFL_Command_IRQn
      IrqNum_ReadCollision   = 1,  ///< Maps to FTFL_ReadCollision_IRQn
   };
