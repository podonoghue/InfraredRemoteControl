 ...
 */
    ...
    */
   enum I2cStopInterrupt : uint8_t {
      I2cStopInterrupt_InterruptDisabled   = I2C_FLT_STOPIE(0),  ///< Interrupt disabled
      I2cStopInterrupt_InterruptEnabled    = I2C_FLT_STOPIE(1),  ///< Interrupt enabled
   };
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   0: I2C0_SCL             = PTE24(ACCEL_SCL)               */  { PinIndex::PTE24,        PcrValue(0x00520UL) },
         /*   1: I2C0_SDA             = PTE25(ACCEL_SDA)               */  { PinIndex::PTE25,        PcrValue(0x00520UL) },
   };
   ...
   static void initPCRs() {
      ...
      PORTE->GPCHR = (0x0520UL|PORT_GPCHR_GPWE(0x0300UL));
   }
   ...
   static void clearPCRs() {
      enablePortClocks(USBDM::PORTE_CLOCK_MASK);
      PORTE->GPCHR = uint32_t(PinMux_Disabled)|PORT_GPCHR_GPWE(0x0300UL);
   }
