...
constexpr PcrValue analoguePcrValue(PcrValue op) {
   ...
   public:
      ...
      ) : value(uint32_t(pinDriveStrength|pinSlewRate)) {
      }
      ...
      constexpr PcrInit(
            ...
            PinAction        pinAction,
            PinStatusFlag    pinStatusFlag
      ) : value(uint32_t(pinDriveStrength|pinSlewRate|pinPull|pinFilter|pinAction|pinStatusFlag)) {
      }
    ...
    */
   static constexpr PcrValue GPIO_DEFAULT_PCR(PinPull_None|PinFilter_None|PinDriveStrength_Low|PinSlewRate_Fast|PinAction_None|PinStatusFlag_ClearEvent|PinMux_Gpio);
...
public:
   ...
   static void setPCR(
      ...
      if constexpr (portAddress != 0) {
         ...
         // Set PCR register for pin
         *PCR = static_cast<uint32_t>(pinPull|pinDriveStrength|pinAction|pinStatusFlag|pinFilter|pinSlewRate|pinMux);
      }
   }
