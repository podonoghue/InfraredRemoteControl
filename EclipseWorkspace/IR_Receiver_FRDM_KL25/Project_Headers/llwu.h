...
// No wake-up peripherals found
   ...
   enum LlwuPin : uint8_t {
      LlwuPin_Ptb0   = 5,   ///< LLWU_P5 [PTB0(A0)]
      LlwuPin_Ptc1   = 6,   ///< LLWU_P6 [PTC1(A5)]
      LlwuPin_Ptc3   = 7,   ///< LLWU_P7 [PTC3(D18)]
      LlwuPin_Ptc4   = 8,   ///< LLWU_P8 [PTC4(D19)]
      LlwuPin_Ptc5   = 9,   ///< LLWU_P9 [PTC5(D20)]
      LlwuPin_Ptc6   = 10,  ///< LLWU_P10 [PTC6(D21)]
      LlwuPin_Ptd4   = 14,  ///< LLWU_P14 [PTD4(D2)]
      LlwuPin_Ptd6   = 15,  ///< LLWU_P15 [PTD6(D32)]
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   5: LLWU_P5              = PTB0(A0)                       */  { PinIndex::PTB0,         PcrValue(0x00100UL) },
         /*   6: LLWU_P6              = PTC1(A5)                       */  { PinIndex::PTC1,         PcrValue(0x00100UL) },
         /*   7: LLWU_P7              = PTC3(D18)                      */  { PinIndex::PTC3,         PcrValue(0x00100UL) },
         /*   8: LLWU_P8              = PTC4(D19)                      */  { PinIndex::PTC4,         PcrValue(0x00100UL) },
         /*   9: LLWU_P9              = PTC5(D20)                      */  { PinIndex::PTC5,         PcrValue(0x00100UL) },
         /*  10: LLWU_P10             = PTC6(D21)                      */  { PinIndex::PTC6,         PcrValue(0x00100UL) },
         /*  11: --                   = --                             */  { PinIndex::INVALID_PCR,  PcrValue(0)         },
         /*  12: --                   = --                             */  { PinIndex::INVALID_PCR,  PcrValue(0)         },
         /*  13: --                   = --                             */  { PinIndex::INVALID_PCR,  PcrValue(0)         },
         /*  14: LLWU_P14             = PTD4(D2)                       */  { PinIndex::PTD4,         PcrValue(0x00100UL) },
         /*  15: LLWU_P15             = PTD6(D32)                      */  { PinIndex::PTD6,         PcrValue(0x00100UL) },
   ...
   static void initPCRs() {
      enablePortClocks(USBDM::PORTB_CLOCK_MASK|USBDM::PORTC_CLOCK_MASK|USBDM::PORTD_CLOCK_MASK);
      PORTB->GPCLR = (0x0100UL|PORT_GPCLR_GPWE(0x0001UL));
      PORTC->GPCLR = (0x0100UL|PORT_GPCLR_GPWE(0x007AUL));
   ...
   static void clearPCRs() {
      ...
      PORTC->GPCLR = uint32_t(PinMux_Disabled)|PORT_GPCLR_GPWE(0x007AUL);
      PORTD->GPCLR = uint32_t(PinMux_Disabled)|PORT_GPCLR_GPWE(0x0050UL);
   }

   /*
    * Template:llwu_me_pe4_filt2_mkl25z4
    */
