...
public:
   ...
   static void setInOut(
      ...
      setInactive();
      // Configure PCR
      Pcr::setPCR(pinPull|pinDriveStrength|pinAction|pinStatusFlag|pinFilter|pinSlewRate);
   }
...
public:
   ...
   static void setInOut(PcrValue pcrValue=defaultPcrValue) {
      ...
      pcr = (pcr & ~PORT_PCR_MUX_MASK) | uint32_t(PinMux_Gpio);
#endif
      /*
       * Set all PCRs.
   ...
   static void setInOut(
      ...
      setInOut(pinPull|pinDriveStrength|pinAction|pinStatusFlag|pinFilter|pinSlewRate);
   }
